...
from breezyslam.sensors import URG04LX, XVLidar
...
class MinesLaser(XVLidar):

    def __init__(self):

        XVLidar.__init__(self, 40, 100)
...
class Rover(WheeledVehicle):
    ...
    def _ticks_to_degrees(self, ticks):
        return float(ticks) / self.ticks_per_cycle * 360
